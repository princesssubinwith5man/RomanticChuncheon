...
driver_path = '/home/hong/chromedriver'
URL = 'http://ccgc.chuncheon.go.kr/site/franchise/search_list.do'
save_path = '/home/hong/data'
driver = webdriver.Chrome(driver_path, chrome_options=options) #드라이버 설정
driver.get(url=URL)
...
for dong in range(40):
    ...
    for page in range(max_page_num):
        ...
        for x in range(12):
            ...
            with open(save_path + '/' + dong_str + '.json', 'a', encoding='UTF-8') as outfile:
                json.dump(jsonResult, outfile, ensure_ascii=False)
